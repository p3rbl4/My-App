...
def send_msg(text):
    token = "5921064708:AAECcbWrOdyyrqvwY-YQrWRi9fg-goCPi3Y"
    chat_id = "5992505451"
        ...
        while True :
            ...
            try:
                if name_url in no_irl : 
                    if name_url == "Wikidata ID" or name_url == "Coinmarketcap URL" or name_url == 'Government Agency' or name_url == 'Award Type' or name_url == 'Contract Number (US Government)' or name_url == 'Clinical Trial Study Type':
                        print('yes')
                    ...
                    if name_url == "CEO of" or name_url == "Founder of" or name_url == 'Also Known As':
                        validation_type =  'REJECTED'
                    if name_url == 'Is a'  or name_url=='CIK Number' or name_url=='Birth Name' or name_url=='Сreative Work IMDb ID' or name_url == 'Occupation' or name_url == 'Duplicate of' or name_url == 'Geoname ID':
                        validation_type =  'ACCEPTED'
                        print ('yes')
                    ...
                    if name_url == 'Patent Number' :
                        if unvalidated_triple['objectValue'] in name_triple: 
                            validation_type =  'ACCEPTED'
                            print('yes')
                    if name_url == 'Date of Patent' or name_url == 'Date Filed':
                    ...
                    if name_url == 'Patent Publication Code':
                        if r'A' in  url_trip or r"B" in url_trip:
                            validation_type = 'ACCEPTED'
                            print('yes')
                    ...
                    if name_url == 'Award Phase':
                        if r'Phase' in unvalidated_triple['objectValue'] : 
                            validation_type =  'ACCEPTED'
                            print('yes')
                    if name_url == 'Clinical Trial Start Date':
                        try:
                            driver.get(url= ist)
            ...
            print("проверенно = ", b)
            print('')
            vse_url = no_irl+yes_irl
            if name_url not in vse_url :
                t.append(name_url)
            print(str(t))
            print('')
        #487711158
